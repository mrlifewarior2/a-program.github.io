!(function (t) {
    ...
    if (
        ...
        t(".navbar-reverse-scroll").length > 0 ? t(".inner-link").smoothScroll({ speed: 900, offset: 0 }) : t(".inner-link").smoothScroll({ speed: 900, offset: -59 }),
    ...
    t(".lightbox-group-gallery-item").each(function () {
        ...
        t(".popup-youtube, .popup-vimeo, .popup-googlemap").magnificPopup({ disableOn: 767, type: "iframe", mainClass: "mfp-fade", removalDelay: 160, preloader: !1, fixedContentPos: !0, closeBtnInside: !1 }),
                            ...
                            a.removeClass("loading"),
                                "" != l && null != l
                                    ...
                                    : (null != e && (e = t.parseJSON(e)),
                                      o.find("input[type=text],input[type=email],input[type=tel],input[type=password],textarea").each(function () {
                                          t(this).val(""), t(this).removeClass("error");
                                      }),
                                      o.find(".g-recaptcha").removeClass("error"),
                                      o.find("input[type=checkbox],input[type=radio]").prop("checked", !1),
                                      o.find(".g-recaptcha").length > 0 && grecaptcha.reset(),
                                      s.removeClass("alert-success").removeClass("alert-danger").hide(),
                                      s.addClass(e.alert).html(e.message),
                                      s.removeClass("d-none").fadeIn("slow").delay(4e3).fadeOut("slow"));
                        },
                    })),
                !1
            );
    ...
    t(document).on("touchstart click", "body", function (e) {
        ...
        t(".left-sidebar-wrapper").length > 0 && t(".left-sidebar-wrapper .left-sidebar-nav").stick_in_parent({ recalc: 1 }),
    ...
    function D() {
        ...
        e >= 200 && z() > i && (t(".navbar-collapse").hasClass("show") && t(".navbar-collapse").removeClass("show"), t("body").hasClass("navbar-collapse-show") && t("body").removeClass("navbar-collapse-show")),
    ...
    function Y() {
        ...
        t(".navbar").hasClass("no-sticky") || (!t(".navbar").hasClass("top-space") && !t(".navbar").hasClass("mobile-top-space")) ? t("body").css("padding-top", "") : t("body").css("padding-top", e + "px"),
            t(".mobileoff-fullscreen-top-space").length >= 0 && z() > 1023 && t(".mobileoff-fullscreen-top-space").css("height", B() - e + "px"),
            t(".fullscreen-top-space").length >= 0 && t(".fullscreen-top-space").css("height", B() - e + "px"),
